...
import com.ucsb.integration.MainPage.Find.FindActivityAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    for(DataSnapshot ds : dataSnapshot.getChildren()){
                        if (ds.getValue(Product.class).getCreatedBy().equals(currentUserID)) {
                            proList.add(ds.getValue(Product.class));
                        }
                    }
                    adapter =  new FindActivityAdapter(proList, ListHistory.this);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ListHistory.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
